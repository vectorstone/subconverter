...
- 局域网样例 192.0.2.10:25500/version 正常返回 subconverter v0.9.0-cecfa0a backend。
...
- PUBLIC_BASE_URL=https://hi.example.com
- DATABASE_URL
- API_TOKEN
...
- [ ] 生产域名使用 hi.example.com，并单独配置 Nginx，不覆盖现有 api.example.com。
